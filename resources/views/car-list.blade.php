...
@endif
    ...
    <div class="flex w-full mt-8 items-center justify-center py-8 bg-white rounded-lg shadow-[0px_10px_20px_#8b82f64d] gap-2">
        ...
        <div class="flex flex-row gap-2 px-4 py-2 border rounded-full shadow-sm bg-white text-gray-700 focus:ring-[#8b82f6] focus:outline-none">
            ...
            <select id="car-brand" onchange="redirectToBrandPage()">
        ...
        <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <select id="car-type" onchange="redirectToTypePage()">
            ...
            <script>
                function redirectToTypePage() {
                    const type = document.getElementById('car-type').value;
                    if (type) {
                        window.location.href = '/vehicles/type/'+type;
                    }
                }
            </script>
...
<path d="M12 7V12H15M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" stroke="#b4b7bc" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <select id="car-year" onchange="redirectToYearPage()">
                <option value="" disabled selected>Antiguedad</option>
            ...
            <script>
                function redirectToYearPage() {
                    ...
                    if (year) {
                        window.location.href = '/vehicles/year/'+year;
                    }
                }
            </script>
    </div>
...
<path d="M22 8H20.5C19.6716 8 19 8.67157 19 9.5V11.9189C19 12.5645 19.4131 13.1377 20.0257 13.3419L22 14" stroke="#b4b7bc" stroke-width="1.5" stroke-linecap="round"/>
    ...
    <select id="car-fuel" onchange="redirectToFuelPage()">
            ...
            <script>
                function redirectToFuelPage() {
                    const fuel = document.getElementById('car-fuel').value;
                    if (fuel) {
                        window.location.href = '/vehicles/fuel/'+fuel;
                    }
                }
            </script>
    </div>
...
<select id="car-transmission" onchange="redirectToTransmissionPage()">
            ...
            <script>
                function redirectToTransmissionPage() {
                    const transmission = document.getElementById('car-transmission').value;
                    if (transmission) {
                        window.location.href = '/vehicles/transmission/'+transmission;
                    }
                }
            </script>
    </div>
...
<path d="M19 7.11111C17.775 5.21864 15.8556 4 13.6979 4C9.99875 4 7 7.58172 7 12C7 16.4183 9.99875 20 13.6979 20C15.8556 20 17.775 18.7814 19 16.8889M5 10H14M5 14H14" stroke="#b4b7bc" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <select id="car-price" onchange="redirectToPricePage()">
            ...
            <script>
                function redirectToPricePage() {
                    ...
                    if (price) {
                        window.location.href = '/vehicles/price/'+price;
                    }
                }
            </script>
    </div>
...
<section class="py-12">
    ...
    @if($vehicles->isEmpty())
        <div class="flex flex-col items-center justify-center gap-y-2">
            <img src="{{ asset('car_icon.svg') }}" alt="Car Icon">
        ...
        @if($vehicle->published === 1)
            ...
            <img class="object-contain object-center w-full h-full transition-all duration-300 ease-in-out group-hover:scale-105" 
                ...
                <div class="p-6">
                    ...
                    <div class="flex justify-end mt-2 text-gray-900">
                        <p class="text-lg">
                            <span class="font-semibold">{{ number_format($vehicle->price, 0, ',', '.') }}</span> 
                            <span class="font-base">€/día</span>
                        </p>
                    </div>
                </div>
            </a>

                ...
                <div>
                    <p class="mt-2 text-sm text-gray-800">
                        ...
                        <button 
                            ...
                            class="underline text-sm text-[#8b82f6] hover:text-[#6f68e5] rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#8b82f6] transition duration-300"
                        >

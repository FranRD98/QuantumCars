...
<section>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <h1 class="text-2xl sm:text-4xl">Gestionar Coches</h1>

            <!-- Botón de añadir nuevo vehículo -->
            <div class="flex sm:justify-end">
                <a class="px-6 sm:px-8 py-3 bg-gray-100 text-[#8b82f6] hover:bg-[#8b82f6] hover:text-white rounded-lg transition duration-500 text-base sm:text-lg font-medium" href="{{ route('vehicle.create') }}">Crear Coche</a>
            </div>
        </div>
